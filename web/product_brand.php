...
try
{
    $sql_selects= $conn->prepare("SELECT * FROM product_brand where brand_id=$id");//การเขียนคำสั่ง SQL
...
<html lang="en">
  ...
  <body style="background-color: #eff0f5;"> 
    ...
    <div><h2><?php echo $row_selects['brand_name']; ?></h2></div>
    <div class="container-product2">
      ...
      {   
        ...
        ON product.product_brand = product_brand.brand_id where product.product_brand = $id ");
        $sql_select->execute();
