<html lang="en">
  ...
  <body style="background-color: #eff0f5;"> 
    ...
    // try
    // {
    //     $sql_selects= $conn->prepare("SELECT * FROM product 
    //     left join product_$column on product.product_$column=product_$column.$column$id ");
    //     $sql_selects->execute();
    ...
    <div class="container-product2">
      ...
      {   
        ...
        LEFT JOIN product_gear ON product.product_gear = product_gear.gear_id order by product_$column.$column$id asc   ");
        $sql_select->execute();
