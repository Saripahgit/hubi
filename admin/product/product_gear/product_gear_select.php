...
<html>
    ...
    <body style="background-color: #eff0f5;">
        ...
        <div class="name_box"><h1>All Gear</h1></div>
                ...
                try
                {
                    ...
                    {        
                        ...
                        <div class="product_show">
                            <p id="product_1"><?php echo $row_select['gear_id'];?></p>
                            <p id="product_1"><?php echo $row_select['gear_name'];?></p>

                            <div id="product_1"><a id="bottom" href="update_admin.php?update=5&update_id=<?php echo $row_select['gear_id']; ?>">Update</a></div> 
                        </div><hr>
