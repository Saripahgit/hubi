...
<html>
    ...
    <body style="background-color: #eff0f5;">
        ...
        <div class="name_box"><h1>All Type</h1></div>
                ...
                try
                {
                    ...
                    {        
                        ...
                        <div class="product_show">
                            <p id="product_1"><?php echo $row_select['type_id'];?></p>
                            <p id="product_1"><?php echo $row_select['type_name'];?></p>

                            <div id="product_1"><a id="bottom" href="update_admin.php?update=4&update_id=<?php echo $row_select['type_id']; ?>">Update</a></div> 
                        </div><hr>
